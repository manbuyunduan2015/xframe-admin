...
chapter: `
        <li class="nav-item has-treeview">
            <a class="nav-link" style="background-color:rgba(255,255,255,.085) !important;" href="javascript:void(0);">
...
qryText: `<div class="col-sm-2 float-left"><input id="xqry_{0}" class="form-control" type="text" placeholder="{1}"></div>`,
...
dlgColumn: `
        <div class="form-group row">
          <label for="dinput_{0}_{1}" class="col-sm-2 col-form-label"><p class="float-right">{2}</p></label>
